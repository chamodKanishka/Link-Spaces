...
<div class="row" style="background-color: #d3a308;color: #795d04;font-size: 20px;padding: 10px;text-align: center">
    <div class="col-sm-3" style="text-align: left;font-weight: bold"><span style="border-right: 2px solid #795d04;padding-right: 50px;padding-left: 20px">JOB OPPORTUNITIES</span></div>
    <div class="col-sm-2"><a href="index.jsp" style="text-decoration: none;color: black"><a href="home.jsp?path=home" style="text-decoration: none;color: black"><span class="headerText">Home</span></a></div>
